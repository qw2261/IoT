package com.example.speechcommandwatch;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SpeechRecognizer mSpeechRecognizer = createSpeechRecognizer(this, ComponentName.unflattenFromString(GOOGLE_RECOGNITION_SERVICE_NAME));
